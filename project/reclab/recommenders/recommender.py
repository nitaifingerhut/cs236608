    ...
    def _select_item(self, item_ids, predictions, num_recommendations):
        ...
        if strategy_type == "greedy":
            ...
            explore_indices = np.random.choice(
                [x for x in range(0, num_items) if x not in exploit_indices], num_explore
            )
            ...
            selected_indices = np.random.choice(range(0, num_items), num_recommendations, p=selection_probs)
